...
import {
    ...
    TypeSignUpStartAction,
    TypeSignUpSuccessAction,
...
export function* signInWithGoogle() {
    try {
        ...
        yield getSnapshotFromUserAuth( (user as IUser) );
...
export function* signUp({ payload: {email, displayName, password}}:TypeSignUpStartAction) {
    try {
...
export function* signInAfterSignUp({ payload: {user, additionalData}}:TypeSignUpSuccessAction) {
